...
function selectRandomUnitFromTech(techLevel)
    ...
    if randomFaction == 5 then
        if not initialFaction then
            local factionTables = {
                AirTables["tech" .. techLevel .. "AeonUnits"],
                AirTables["tech" .. techLevel .. "CybranUnits"],
                AirTables["tech" .. techLevel .. "SeraUnits"],
                AirTables["tech" .. techLevel .. "UEFUnits"],
            ...
            randomTable = AirTables["tech" .. techLevel .. factionKey[randomFaction] .. "Units"]
        end
    else
...
function SpawnAirUnits()
 WaitSeconds(180 + ScenarioInfo.Options.opt_Survival_BuildTime)

    while true do
        WaitSeconds(5)

        local area = Areas.PickRandomArea(Areas.spawnAirArea)
