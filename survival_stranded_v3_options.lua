options = 
{
	...
	{
		default = 6,
		label = "Survival: Enemy Faction",
		help = "Pick the faction you want to fight in game!",
		key = 'opt_EnemyFaction',
		pref = 'opt_EnemyFaction',
		values = {
			{ text = "AllFactions", help = "Fight All Factions!", key = 0, },
			{ text = "AEON", help = "Fight the Illuminate!", key = 1, },
			{ text = "CYRBAN", help = "Fight the Cyrban Warlords!", key = 2, },
			{ text = "SERA", help = "Fight the unstoppable SERA!", key = 3, },
			{ text = "UEF", help = "Fight the UEF!", key = 4, },
			{ text = "RandomFaction", help = "Fight a Random Faction", key = 5, },
		},
	},
};
