...
ScenarioInfo = {
    ...
    map = '/maps/survival_stranded_v3.v0005/survival_stranded_v3.scmap',
    save = '/maps/survival_stranded_v3.v0005/survival_stranded_v3_save.lua',
    script = '/maps/survival_stranded_v3.v0005/survival_stranded_v3_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
